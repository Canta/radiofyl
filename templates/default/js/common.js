...
function play_transmision_random(){
...
function UI_load_transmisiones_online(){
...
$(document).ready(
	function(){
		...
		get_transmisiones_online({on_success: UI_load_transmisiones_online});
		
		//animación inicial
		window.setTimeout(
		function(){
			$($("[class='seccion']")[0]).animate({left:"15%"},500);
			window.setTimeout("play_transmision_random();",800);
		}
		,1000);
